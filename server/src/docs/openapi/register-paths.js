...
export function registerOpenApiPaths(registry) {
  ...
  registry.registerPath({
    ...
    summary: 'Submit partner payment (public, multipart)',
    request: {
      body: {
        content: {
          'multipart/form-data': {
  ...
  registry.registerPath({
    method: 'post',
    path: '/api/v1/vps-users/{id}/renew',
    tags: ['VPS Users'],
    summary: 'Renew VPS user subscription',
    security: bearerSecurity,
    request: {
      params: mongoIdParams,
      body: {
        content: { 'application/json': { schema: renewVpsUserSchema } },
      },
    },
    responses: {
      200: {
