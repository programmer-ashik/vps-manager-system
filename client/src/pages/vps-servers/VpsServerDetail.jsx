    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="border rounded-lg bg-white dark:bg-neutral-800 shadow-sm divide-y">
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-xs text-neutral-500 uppercase tracking-wide">Monitoring</p>
            <p className="mt-1 text-sm">{server.isActive ? 'Active (auto-ping enabled)' : 'Inactive'}</p>
          </div>
          <div>
            <p className="text-xs text-neutral-500 uppercase tracking-wide">Last Pinged</p>
            <p className="mt-1 text-sm">
              {server.lastPingedAt ? new Date(server.lastPingedAt).toLocaleString() : 'Never'}
            </p>
          </div>
        </div>
