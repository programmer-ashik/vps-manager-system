...
export default function VpsServersList() {
  ...
  if (isError)
    return <div className='p-4 text-red-500'>Failed to load VPS servers.</div>;
      ...
      <div className='flex flex-wrap items-start justify-between gap-4 mb-6'>
        <div>
          ...
          <p className='text-sm text-neutral-600 dark:text-neutral-400 mt-1'>
            Manage VPS inventory — active servers are pinged every 6 hours
          </p>
        </div>
        <Link
          to='/vps-servers/new'
        ...
        <table className='w-full text-sm'>
          <thead className='bg-neutral-50 dark:bg-neutral-900 border-b'>
            <tr>
              ...
              <th className='text-left p-4'>Ping Status</th>
              <th className='text-left p-4'>Last Pinged</th>
              ...
              data.map((item) => (
                ...
                >
                  ...
                  <td className='p-4 text-xs text-neutral-500'>
                    {item.lastPingedAt
                      ? new Date(item.lastPingedAt).toLocaleString()
                      : "—"}
                  </td>
                  <td className='p-4'>
